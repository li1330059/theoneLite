<template>
	<div class="shopping-modifyPayPassword">
		<el-dialog
		...
		>
		  <div class="dialog-content">
		    <div class="dialog-form">
		      <div v-if="!(userInfo.realname && userInfo.idNumber)">
		        <div class="form-line">
  ...
  methods: {
    ...
    async submit() {
      ...
      if (password == agianPassword) {
        ...
        let result = await this.$api.operationChangePayPw({
          ...params,
          bankUuid,
        });
